...
import { SEGMENT_3_CONFIG } from '../config';
import { COLORS } from '../../../config/theme';
import { ClickFeedbackState } from '../types';

// Toggle for coordinate calibration helper
const DEV_COORDINATE_HELPER = true;

export const Segment3_Insights: React.FC = () => {
  const frame = useCurrentFrame();

  const { screenStates, inputFields, interactions, title, subtitle } = SEGMENT_3_CONFIG;
  ...
  return (
    ...
    >
      ...
      >
        <div
          style={{
            ...
            borderRadius: 2,
            width: `${(frame / SEGMENT_3_CONFIG.durationFrames) * 100}%`,
      ...
      {/* Coordinate calibration helper (DEV only) */}
