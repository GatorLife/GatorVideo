...
import { SEGMENT_2_CONFIG } from '../config';
...
export const Segment2_UserEvaluations: React.FC = () => {
  const frame = useCurrentFrame();

  const { screenStates, inputFields, interactions, title, subtitle } = SEGMENT_2_CONFIG;
      ...
      >
        <div
          style={{
            ...
            borderRadius: 2,
            width: `${(frame / SEGMENT_2_CONFIG.durationFrames) * 100}%`,
